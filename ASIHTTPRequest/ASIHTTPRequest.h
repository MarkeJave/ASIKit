...
typedef enum _ASINetworkErrorType {
    ...
    ASILinkerErrorType = 404,
    ASIServerErrorType = 500
...
typedef void (^ASIProgressBlock)(ASIHTTPRequest*,unsigned long long size, unsigned long long total);
...
@property (retain,readonly) NSRecursiveLock *cancelledLock;
#if TARGET_OS_IPHONE && __IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_4_0
